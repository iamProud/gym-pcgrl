...
class Curriculum_Env4(CurriculumSokobanEnv_v4):
    metadata = {
        'render.modes': ['human', 'rgb_array', 'tiny_human', 'tiny_rgb_array'],
        'render_modes': ['human', 'rgb_array', 'tiny_human', 'tiny_rgb_array'],
    }
    ...
    def __init__(self, **kwargs):
        ...
        super(Curriculum_Env4, self).__init__(**kwargs)

class Curriculum_PushAndPull_Env1(CurriculumSokobanEnv_PushAndPull_v1):
    metadata = {
        'render.modes': ['human', 'rgb_array', 'tiny_human', 'tiny_rgb_array'],
        'render_modes': ['human', 'rgb_array', 'tiny_human', 'tiny_rgb_array'],
    }
...
class Single_Env2(SingleSokobanEnv_v2):
    metadata = {
        'render.modes': ['human', 'rgb_array', 'tiny_human', 'tiny_rgb_array'],
    ...
    def __init__(self, **kwargs):
        kwargs['max_steps'] = kwargs.get('max_steps', 200)
        super(Single_Env2, self).__init__(**kwargs)
